...
class ClientTest extends \PHPUnit_Framework_TestCase
{
    ...
    function testEventWritten()
    {
        ...
        $echoClient = $this->getMock('\Talis\EchoClient\Client', array('getPersonaClient', 'getHttpClient'));
    ...
    function testHitsCallsAnalytics()
    {
        ...
        $echoClient = $this->getMock('\Talis\EchoClient\Client', array('getAnalytics'));
